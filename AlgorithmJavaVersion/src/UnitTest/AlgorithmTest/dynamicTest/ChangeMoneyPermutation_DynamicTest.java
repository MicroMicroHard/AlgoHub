...
public class ChangeMoneyPermutation_DynamicTest {

    @Test
    public void TestChangeMoneyPermutation_Dynamic() {
        test(new ChangeMoneyPermutation_Dynamic());
    }

    public void test(ChangeMoneyPermutation_Dynamic changeMoneyDynamic) {
