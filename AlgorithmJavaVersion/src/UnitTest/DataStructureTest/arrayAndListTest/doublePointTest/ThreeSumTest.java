...
public class ThreeSumTest extends FindValueinArrayTest {
    ...
    public void testexist() {
        boolean flag = f.existMethod(demoArray01_y, target01_3s_y);
        assert flag;
        flag = f.existMethod(demoArray02_y, target02_3_y);
        assert flag;
        flag = f.existMethod(demoArray03_y, target03_3_y);
        assert flag;

        flag = f.existMethod(demoArray01_n, target01_n_all);
        assert !flag;
        flag = f.existMethod(demoArray02_n, target02_n_all);
        assert !flag;
        flag = f.existMethod(demoArray03_n, target03_n_all);
        assert !flag;
    }
