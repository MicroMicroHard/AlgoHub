 ...
 */
public class TwoSumTest extends FindValueinArrayTest {
    ...
    public void testexist() {
        boolean flag = f.existMethod(demoArray01_y, target01_2_y);
        assert flag;
        flag = f.existMethod(demoArray02_y, target01_2_y);
        assert flag;
        flag = f.existMethod(demoArray03_y, target03_2_y);
        assert flag;
