...
import DataStructure.arrayRelevant.matrix.ClockwiseSpiralMatrix;
import DataStructure.arrayRelevant.matrix.ClockwiseSpiralMatrix2;
...
public class ClockwiseSpiralMatrixTest {
    ...
    //点位计算法
    @Test
    public void testClockwiseSpiralMatrix() {
        Test(new ClockwiseSpiralMatrix());
    }

    //转置法
    @Test
    public void testClockwiseSpiralMatrix2() {
        Test(new ClockwiseSpiralMatrix2());
    }


    public void Test(ClockwiseSpiralMatrix clockwiseSpiralMatrix) {
        int[] target = clockwiseSpiralMatrix.pointCount(Demo01);
