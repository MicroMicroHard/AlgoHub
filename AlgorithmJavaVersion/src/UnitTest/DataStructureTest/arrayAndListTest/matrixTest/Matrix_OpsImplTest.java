 ...
 * @blogURL
 */
public class Matrix_OpsImplTest {

    @Test
    public void TestMatrixMultiply() {
        Test(new MatrixOpsImpl());
    }

    public void Test(MatrixOpsImpl instance) {
        int[][] target = instance.MultiplyMethod(Demo01Materix_a1, Demo01Materix_b1);
        assert Arrays.deepEquals(target, Assert01Materix_c1);

        target = instance.MultiplyMethod(Demo01Materix_a2, Demo01Materix_b2);
        assert Arrays.deepEquals(target, Assert01Materix_c2);

        target = instance.MultiplyMethod(Demo01Materix_a3, Demo01Materix_b3);
        assert Arrays.deepEquals(target, Assert01Materix_c3);

        target = instance.MultiplyMethod(Demo01Materix_a4, Demo01Materix_b4);
