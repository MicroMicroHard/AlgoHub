...
public class Calculator_WithOutBracketsTest extends Calculator_TestData {

    @Test
    public void testCalculator_WithOutBrackets() {
        test(new Calculator_Impl_Brackets_WithOut());
    }

    public void test(Calculator_Impl_Brackets_WithOut instance) {
        //1、只带加减的表达式     【仅包括：加减】
