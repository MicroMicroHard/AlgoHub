...
public class StringCompareTestDemo {
    ...
    public void testCompare(StringCompare stringCompare) {
        //正案例
        boolean flag = stringCompare.compareMethod(source01, pattern01);
        assert flag;
        flag = stringCompare.compareMethod(source02, pattern02);
        assert flag;
        flag = stringCompare.compareMethod(source03, pattern03);
        assert flag;
        flag = stringCompare.compareMethod(source04, pattern04);
        assert flag;
        flag = stringCompare.compareMethod(source05, pattern05);
        assert flag;
        flag = stringCompare.compareMethod(source06, pattern06);
        assert flag;
        flag = stringCompare.compareMethod(source07, pattern07);
        assert flag;
        //反案例
        flag = stringCompare.compareMethod(source01f, pattern01f);
        assert !flag;
        flag = stringCompare.compareMethod(source02f, pattern02f);
        assert !flag;
        flag = stringCompare.compareMethod(source03f, pattern03f);
        assert !flag;
        flag = stringCompare.compareMethod(source04f, pattern04f);
        assert !flag;
        flag = stringCompare.compareMethod(source05f, pattern05f);
        assert !flag;
        flag = stringCompare.compareMethod(source06f, pattern06f);
        assert !flag;
    }
