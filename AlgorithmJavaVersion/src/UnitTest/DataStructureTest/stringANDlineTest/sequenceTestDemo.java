...
public class sequenceTestDemo {
    ...
    public void testCompare(StringCompare sequenceCompare){
        //������
        boolean flag = sequenceCompare.compareMethod(source01,pattern01);
        assert flag;
        flag = sequenceCompare.compareMethod(source02,pattern02);
        assert flag;
        flag = sequenceCompare.compareMethod(source03,pattern03);
        assert flag;
        flag = sequenceCompare.compareMethod(source04,pattern04);
        assert flag;
        //������
        flag = sequenceCompare.compareMethod(source01f,pattern01f);
        assert !flag;
        flag = sequenceCompare.compareMethod(source02f,pattern02f);
        assert !flag;
        flag = sequenceCompare.compareMethod(source03f,pattern03f);
        assert !flag;
        flag = sequenceCompare.compareMethod(source04f,pattern04f);
        assert !flag;
        flag = sequenceCompare.compareMethod(source05f,pattern05f);
        assert !flag;
    }
